...
-- -----------------------------------------------------
-- Table `woordenschatapp`.`woord`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `woordenschatapp`.`woord` (
                                                         `idWoord` INT NOT NULL AUTO_INCREMENT,
                                                         `Woord` VARCHAR(45) NOT NULL,
                                                         `Soort` VARCHAR(45) NOT NULL,
                                                         PRIMARY KEY (`idWoord`),
                                                         UNIQUE INDEX `idWoordenlijst_UNIQUE` (`idWoord` ASC) VISIBLE)
    ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `woordenschatapp`.`betekenis`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `woordenschatapp`.`betekenis` (
                                                             `idbetekenis` INT NOT NULL AUTO_INCREMENT,
                                                             `betekenisWoord` VARCHAR(300) NOT NULL,
                                                             PRIMARY KEY (`idbetekenis`),
                                                             UNIQUE INDEX `idbetekenis_UNIQUE` (`idbetekenis` ASC) VISIBLE)
    ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `woordenschatapp`.`woord_has_betekenis`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `woordenschatapp`.`woord_has_betekenis` (
                                                                       `woord_idWoord` INT NOT NULL,
                                                                       `betekenis_idbetekenis` INT NOT NULL,
                                                                       PRIMARY KEY (`woord_idWoord`, `betekenis_idbetekenis`),
                                                                       INDEX `fk_woord_has_betekenis_betekenis1_idx` (`betekenis_idbetekenis` ASC) VISIBLE,
                                                                       INDEX `fk_woord_has_betekenis_woord_idx` (`woord_idWoord` ASC) VISIBLE,
                                                                       CONSTRAINT `fk_woord_has_betekenis_woord`
                                                                           FOREIGN KEY (`woord_idWoord`)
                                                                               REFERENCES `woordenschatapp`.`woord` (`idWoord`)
                                                                               ON DELETE NO ACTION
                                                                               ON UPDATE NO ACTION,
                                                                       CONSTRAINT `fk_woord_has_betekenis_betekenis1`
                                                                           FOREIGN KEY (`betekenis_idbetekenis`)
                                                                               REFERENCES `woordenschatapp`.`betekenis` (`idbetekenis`)
                                                                               ON DELETE NO ACTION
                                                                               ON UPDATE NO ACTION)
    ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `woordenschatapp`.`login`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `woordenschatapp`.`login` (
